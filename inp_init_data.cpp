...
//set function
std::string Input_data::Set_str_value(std::stringstream &ss){
    std::string str;
    ss >> str;
    return str;
}

int Input_data::Set_int_value(std::stringstream &ss){
    std::string str;
    int num;
    ss >> str;
    num = std::stoi(str);
...
double Input_data::Set_double_value(std::stringstream &ss){
    std::string str;
    double dbl;
    ss >> str;
    dbl = std::stod(str);
...
bool Input_data::Set_bool_value(std::stringstream &ss){
    std::string str;
    bool active;
    ss >> str;
...
ChVector<> Input_data::Set_ChVector(std::stringstream &ss){
    ChVector<double> chv;
...
ChQuaternion<> Input_data::Set_ChQuaternion(std::stringstream &ss){
...
std::vector<std::string> Input_data::Set_str_vec(std::stringstream &ss){
