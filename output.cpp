...
void Output::write(int step, double time, WheeledVehicle &veh, Driver_model_controller dvr, RigidTerrain &ter, Cfd2Vehicle &c2v, Vehicle2Cfd &v2c){
...
void Output::write_veh_status(int step, double time, WheeledVehicle &veh, Driver_model_controller dvr, RigidTerrain &ter){
